...
load_dotenv()
'''
Script Untuk Menjalankan SAVE IMAGE berdasarkan ORDER BY viewsnya Comic DESC

python manyChapters.py limit offset
'''
...
query = """ SELECT chapters.id, chapters.chapter_title, chapters.content, comics.title 
                ...
                ORDER BY comics.views DESC LIMIT """+ limit + " OFFSET "+ offset
print(query)
# Execute Query
